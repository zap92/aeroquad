...
void AHRSupdate() {
  ...
  accelMagnitude = sqrt(filteredAccel.value[XAXIS]*filteredAccel.value[XAXIS] +\
                        ...
                        filteredAccel.value[ZAXIS]*filteredAccel.value[ZAXIS]);       
  ax = filteredAccel.value[XAXIS] / accelMagnitude;
  ay = filteredAccel.value[YAXIS] / accelMagnitude;
  az = filteredAccel.value[ZAXIS] / accelMagnitude;
  ...
  gx = gyro.value[ROLL]  + exInt + exAcc*kpAcc + X_MAG_PROPORTIONAL;
  gy = gyro.value[PITCH] + eyInt + eyAcc*kpAcc + Y_MAG_PROPORTIONAL;
  gz = gyro.value[YAW]   + ezInt + ezAcc*kpAcc + Z_MAG_PROPORTIONAL;
  ...
  q3q3 = q3*q3;
    ...
    vzEst = sum1 + sum3 * kVz;
  #else
    angle.value[ROLL]  =  atan2(2 * (q0q1 + q2q3), q0q0 - q1q1 - q2q2 + q3q3);
    angle.value[PITCH] =  -asin(2 * (q1q3 - q0q2));
    #if defined(HMC5843) | defined(HMC5883)
