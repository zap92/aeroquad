...
void sendByteI2C(int deviceAddress, byte dataValue) __attribute__ ((noinline));
...
byte readByteI2C(int deviceAddress) __attribute__ ((noinline));
...
int readWordI2C(int deviceAddress) __attribute__ ((noinline));
...
int readWordWaitI2C(int deviceAddress) __attribute__ ((noinline));
...
int readReverseWordI2C(int deviceAddress) __attribute__ ((noinline));
...
byte readWhoI2C(int deviceAddress) __attribute__ ((noinline));
...
void updateRegisterI2C(int deviceAddress, byte dataAddress, byte dataValue) __attribute__ ((noinline));
