...
Gyroscope_IDG_IDZ500::Gyroscope_IDG_IDZ500() {
  
}

void Gyroscope_IDG_IDZ500::setAref(float _aref) {
  aref = _aref;
  gyroScaleFactor = radians((aref/1024.0) / 0.002);  // IDG/IXZ500 sensitivity = 2mV/(deg/sec)
} 

void Gyroscope_IDG_IDZ500::initialize(void) {
...
void Gyroscope_IDG_IDZ500::calibrate() {
