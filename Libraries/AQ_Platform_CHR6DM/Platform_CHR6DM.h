...
// Scale factors
const double SCALE_YAW        = 0.000191747108; // rad/LSB // 0.0109863; // deg/LSB
const double SCALE_PITCH      = 0.000191747108; 
const double SCALE_ROLL       = 0.000191747108;
const double SCALE_YAW_RATE   = 0.000239684321; // rad/s/LSB // 0.0137329; // deg/s/LSB
const double SCALE_PITCH_RATE = 0.000239684321;
const double SCALE_ROLL_RATE  = 0.000239684321;
const double SCALE_MAG_X      = 0.061035; // mGauss/LSB
const double SCALE_MAG_Y      = 0.061035;
const double SCALE_MAG_Z      = 0.061035;
const double SCALE_GYRO_X     = 0.01812; // deg/s/LSB
