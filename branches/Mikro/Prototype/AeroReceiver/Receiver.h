...
// Pin 2=18, Pin 3=19, Pin 4=20, Pin 5=21, Pin 6=22, Pin 7=23, Pin 8=0, Pin 9=1, Pin 10=2, Pin 11=3
...
#define AUX4PIN 10
#define AUX5PIN 11
int receiverPin[10] = {18, 19, 20, 21, 22, 23, 0, 1, 2, 3}; // defines ATmega328P pins (Arduino pins converted to ATmega328P pinouts)
int receiverChannel[10] = {THROTTLEPIN, ROLLPIN, PITCHPIN, YAWPIN, MODEPIN, AUX1PIN, AUX2PIN, AUX3PIN, AUX4PIN, AUX5PIN}; // defines Arduino pins
