...
class SoftwareServo
{
  ...
  public:
    ...
    uint8_t read();
    uint8_t attached();
    void setMinimumPulse(uint16_t);  // pulse length for 0 degrees in microseconds, 1000uS (540uS) default
    void setMaximumPulse(uint16_t);  // pulse length for 180 degrees in microseconds, 2000uS (2400uS) default
