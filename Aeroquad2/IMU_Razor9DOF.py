...
scene2 = display(title='IMU test',x=0, y=0, width=500, height=200,center=(0,0,0), background=(0,0,0))
scene2.range=(1,1,1)
scene.width=500
scene.y=200
...
# IMU object
platform = box(length=0.9, height=0.05, width=0.65, color=color.red)
