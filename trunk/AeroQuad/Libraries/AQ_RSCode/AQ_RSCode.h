...
void
mult_polys (byte dst[], byte p1[], byte p2[])
{
  short i, j;
  byte tmp1[MAXDEG*2];
 ...
 *
 * The parity bytes are deposited into data array after the message
 * 
 */

void
encode_data (byte msg[], int nbytes)
{
  byte i, LFSR[NPAR+1],dbyte, j;
