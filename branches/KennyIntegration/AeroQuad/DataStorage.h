...
// HJI   receiver.setXmitFactor(1.0);
//  levelLimit = 500.0;
//  levelOff = 150.0;
// HJI  gyro.setSmoothFactor(1.0);
// HJI  accel.setSmoothFactor(1.0);
  // AKA - old setOneG not in SI - accel.setOneG(500);
// HJI  accel.setOneG(9.80665); // AKA set one G to 9.8 m/s^2
// HJI  timeConstant = 7.0;
...
// HJI  accel.setOneG(readFloat(ACCEL1G_ADR));
...
// HJI  writeFloat(receiver.getXmitFactor(), XMITFACTOR_ADR);
// HJI  writeFloat(gyro.getSmoothFactor(), GYROSMOOTH_ADR);
// HJI  writeFloat(accel.getSmoothFactor(), ACCSMOOTH_ADR);
// HJI  writeFloat(timeConstant, FILTERTERM_ADR);
...
// HJI  writeFloat(accel.getOneG(), ACCEL1G_ADR);
