...
Receiver_328p::Receiver_328p() {

}

void Receiver_328p::initialize(void) {
...
#endif  //#if defined (__AVR_ATmega328P__) || defined(__AVR_ATmegaUNO__)
