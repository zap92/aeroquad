...
void measureGyro() {
  ...
  int gyroADC[3];
  gyroADC[YAXIS] = readWordI2C() - gyroZero[YAXIS];
  gyroADC[XAXIS] = readWordI2C() - gyroZero[XAXIS];
  gyroADC[ZAXIS] = gyroZero[ZAXIS] - readWordI2C();
...
void measureGyroSum() {
  ...
  gyroSample[YAXIS] += readWordI2C();
  gyroSample[XAXIS] += readWordI2C();
  gyroSample[ZAXIS] += readWordI2C();
