...
void commandMotors() {
  ...
  #ifdef I2CWrite 
    Motor[FRONTMOTORID]=(motorCommand[FRONT] * mMotorCommand) + bMotorCommand-126;  // Setto la potenza in uscita per il motore selezionato
    Motor[REARMOTORID]=(motorCommand[REAR] * mMotorCommand) + bMotorCommand-126;  // Setto la potenza in uscita per il motore selezionato
    Motor[RIGHTMOTORID]=(motorCommand[RIGHT] * mMotorCommand) + bMotorCommand-126;  // Setto la potenza in uscita per il motore selezionato
    Motor[LEFTMOTORID]=(motorCommand[LEFT] * mMotorCommand) + bMotorCommand-126;  // Setto la potenza in uscita per il motore selezionato
    I2cMotorWrite();	
